...
import TPOTableActions from "@/components/dashboard/superadmin/TPOTableActions";
...
const TPOTableColumns = [
  ...
  },
  {
    id: "actions",
    enableHiding: false,
    cell: ({ row }) => <TPOTableActions row={row.original} />,
    size: 50,
  },
];

export default TPOTableColumns;
