...
import pdfLogo from "../../../assets/adobe.png";
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2 px-1">
                {studentDetails?.certificate?.map((curr, index) => {
                  return (
                    <a
                      href={curr.value}
                      target="_blank"
                      key={index}
                      className="text-[15px] text-muted-foreground font-medium flex gap-2 items-center"
                    >
                      <img
                        src={pdfLogo}
                        alt="Pdf"
